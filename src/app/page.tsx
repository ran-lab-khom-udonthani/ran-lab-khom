...
const faqs = [
  ...
  {
    q: "ลับกรรไกรตัดผมที่ไหนดี ในอุดรธานี",
    a: "ร้านลับคมอุดรธานี By ช่างเจี๊ยบ รับลับกรรไกรตัดผม กรรไกรซอย กรรไกรตัดหนัง ของช่างตัดผมและร้านเสริมสวยในอุดรธานี คมลื่น ตัดไม่กินผม ส่งรูปให้ช่างประเมินทางไลน์ก่อนได้",
  },
  {
    q: "ลับมีด ลับกรรไกร ส่งทางไปรษณีย์ได้ไหม",
    a: "ได้ครับ ส่งพัสดุมาที่ร้านได้เลย (ลับคมอุดรธานี 254/4 ถนนอดุลยเดช ต.หมากแข้ง อ.เมือง จ.อุดรธานี 41000) ลับเสร็จส่งกลับ เหมาะกับลูกค้าต่างอำเภอและต่างจังหวัด ทักไลน์นัดก่อนได้",
  },
  {
    q: "ลับปัตตาเลี่ยนหรือกรรไกรตัดขนสุนัข แมว ที่ไหน",
    a: "รับลับใบมีดปัตตาเลี่ยนตัดขนสัตว์ และกรรไกรกรูมมิ่งสำหรับร้านตัดขนหมาแมว ตัดลื่นไม่ดึงขน คมกลับมาเหมือนใหม่",
  },
  {
    q: "หาร้านลับคมใกล้ฉันในอุดรธานี",
    a: "ร้านอยู่ในตัวเมืองอุดรธานี ถนนอดุลยเดช ต.หมากแข้ง ใกล้โรงเรียนดอนบอสโก ตรงข้าม CR7 สนุกเกอร์ เปิดทุกวัน 09:00–17:00 มีหน้าร้านจริง แวะมาหรือส่งของมาลับได้",
  },
];
